...
import easyorderappdesktop.ui.controller.FacturasDesktopFxmlController;
 ...
 * @author Igor
 */
public class FacturasApplication extends javafx.application.Application {
	...
	public void start(Stage stage) throws Exception {
		...
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/easyorderappdesktop/ui/fxml/FacturasDesktopFXMLDocument.fxml"));

		Parent root = (Parent) loader.load();

		//Get controller for graph 
		FacturasDesktopFxmlController controller = ((FacturasDesktopFxmlController) loader.getController());
