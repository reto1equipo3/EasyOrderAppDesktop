...
import easyorderappdesktop.businessLogic.ProductsManagerFactory;
import static easyorderappdesktop.businessLogic.ProductsManagerFactory.REST_WEB_CLIENT_TYPE;
import easyorderappdesktop.ui.controller.ProductController;
 ...
 * @author Igor
 */
public class EasyOrderAppDesktop extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        FXMLLoader loader=new FXMLLoader(
                getClass().getResource("/easyorderappdesktop/ui/view/Product.fxml"));
